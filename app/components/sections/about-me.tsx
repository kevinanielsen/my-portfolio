    ...
    >
      <div className="max-w-7xl gap-4 flex flex-col p-8">
        ...
        <p>
          ...
          frameworks to explore, and I&apos;m open to working with clients from
          ...
          I&apos;ve completed courses on test-driven development, and building
          web apps with React.js, HTML, and Typescript. I&apos;ve also developed
          a workout tracker with features such as tracking your progression on a
          chosen exercise.
          <br />
          <br />
